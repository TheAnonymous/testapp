package org.jakoboesterling.test.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(org.jakoboesterling.test.repository..*)" +
            " || within(org.jakoboesterling.test.service..*)" +
            " || within(org.jakoboesterling.test.web.rest..*)"
    )
