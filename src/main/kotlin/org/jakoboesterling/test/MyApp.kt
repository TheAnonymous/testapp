package org.jakoboesterling.test

import io.github.jhipster.config.DefaultProfileUtil
import io.github.jhipster.config.JHipsterConstants
import java.net.InetAddress
import java.net.UnknownHostException
import org.jakoboesterling.test.config.ApplicationProperties
...
class MyApp(private val env: Environment) : InitializingBean {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<MyApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(MyApp::class.java)
